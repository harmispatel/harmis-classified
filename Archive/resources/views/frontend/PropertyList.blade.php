                        ...
                        <div class="pro_info_main">
                            ...
                            <div class="pro_info_box" id="bedroomDiv">
                                <div class="pro_info_box_inr" id="bedroomClose">
                                    ...
                                    <div class="form-check check_item_box">
                                        <button class="btn btn-sm btn-success reset_bt" onclick="selectedBedroom(1)">reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pro_info_main">
                            ...
                            <div class="pro_info_box" id="categoryDiv">
                                <div class="pro_info_box_inr">
                                    ...
                                    @endforeach
                                    <div class="form-check check_item_box">
                                        <button class="btn btn-sm btn-success reset_bt" onclick="selectedCategory(1)">reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pro_info_main">
                            ...
                            <div class="pro_info_box" id="conditionDiv">
                                <div class="pro_info_box_inr" id="bedroomClose">
                                    ...
                                    <div class="form-check check_item_box">
                                        <button class="btn btn-sm btn-success reset_bt" onclick="selectedCondition(1)">reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pro_info_main">
                            ...
                            <div class="pro_info_box" id="floorDiv">
                                <div class="pro_info_box_inr">
                                    ...
                                    <div class="form-check check_item_box">
                                        <button class="btn btn-sm btn-success reset_bt" onclick="selectedFloor(1)">reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="property_list_inr_box post-grid" id="map-property-lists">
                            ...
                            <div class="row" style="justify-content: center;">
                                <div class="col-12 ajax-load text-center d-none">
                                    <p><img src="{{asset('public/img/loader.png')}}">Load More Post...</p>
                                </div>
                            </div>
                    ...
                    if (res) {
                        ...
                        let markersajax = listPro.map((propertyData, i) => {
                            ...
                            marker.addListener("click", () => {
                                ...
                                infoWindow.setContent('<div class="post-item card">\
                                    <a href="{{ url("single-property-details") }}/'+ propertyData.slug +'"><img src="public/multiImage/'+ propertyData.image +'">\
                                        <div class="re-img">\
                                            <div class="re-text">\
                                        ...
                                        <div class="img-pri-abo">\
                                            <h3><i class="fa-solid fa-rupee-sign"></i> <strong>'+ propertyData.price +'</strong></h3>\
                                        </div>\
                                    </a>\
                                    </div>\
                                    <div class="pro_inr_map">\
                                    <h4><b> '+ propertyData.name +'</b></h4>\
                                    </div>');
