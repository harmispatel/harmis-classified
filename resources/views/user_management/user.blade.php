                                    ...
                                    @foreach ($showUserData as $userData)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <i class="fa fa-trash text-danger deleteBtn" style="cursor: pointer;" data-toggle="modal" data-target="#exampleModal" data-target-id="{{ route('show_user.destroy',$userData->id) }}" title="Delete"></i>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
