...
<body class="aa-price-range">
  ...
  <section class="property-details-main">
      <div class="pro-details-slide position-relative">
          <div class="swiper">
            @php
            ...
            @endphp
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img class="img-fluid" style="background-image: url('{{asset('public/multiImage/'.$img)}}')" />
                </div>
                @endforeach
              </div>
      ...
      <div class="property_slider_info-main">
        <div class="container">
        ...
        <div class="col-md-4">
          <div class="agent-info">
            ...
            <div class="agent-contact">
                ...
                <p><i class="fa-solid fa-phone"></i> {{ ($propertyDetails->hasOneUser['mobile'] != '') ? $propertyDetails->hasOneUser['mobile'] : ''}}</p>
                </div>
            {{-- @endif --}}
        </div>
        <div>
