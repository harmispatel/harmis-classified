                    ...
                    if (res) {
                        ...
                        let markersajax = listPro.map((propertyData, i) => {
                            ...
                            marker.addListener("click", () => {
                                infoWindow.setContent('<div><h4><b> '+ propertyData.name +'</b></h4></div><div><img src="https://harmistechnology.com/harmis-classified/public/mainImage/'+ propertyData.image +'"></div>');
